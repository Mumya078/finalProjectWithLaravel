    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body" style="border-bottom: 1px solid #CCCED0;margin-left: 20px;margin-right: 20px;padding-bottom: 20px">
                ...
                <div class="login-register">
                    <div class="flex-column">
                        ...
                        <a href="{{route('register')}}" class="btn btn-primary btn-sm">Kaydol</a>
                    </div>
                </div>
            </div>
        </div>
